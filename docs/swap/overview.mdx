---
title: "Swap Overview"
description: "How token swaps work on Argyros and which integration path to choose."
llmDescription: "Overview of the Argyros swap lifecycle on Fogo: get quote, build transaction or get instructions, sign and submit. Explains when to use POST /swap vs POST /instructions, ExactIn vs ExactOut swap modes, Fogo capabilities (5 max hops, Vortex/Fluxbeam/Fogo.fun DEXs), supported tokens, and links to detailed pages for each step. Solana support coming soon."
---
