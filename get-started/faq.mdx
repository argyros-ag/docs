---
title: "FAQ"
description: "Frequently asked questions about the Argyros API."
llmDescription: "Frequently asked questions about Argyros. Covers supported chains (Fogo live, Solana coming soon), P-Token benefits preview, supported tokens on Fogo (Vortex, Fluxbeam, Fogo.fun), quote freshness, devnet support, transaction size limits, ExactIn vs ExactOut, fee structure, rate limits, multi-hop behavior, and how to monitor API status."
---
...
Any SPL token with liquidity on a supported DEX on Fogo: Vortex, Fluxbeam, or Fogo.fun. If a direct pool doesn't exist, the routing engine tries multi-hop paths through intermediate tokens like SOL or USDC.
