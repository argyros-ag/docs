...
llmDescription: "Argyros API changelog. Tracks API updates, new features, breaking changes, and deprecations in reverse chronological order."
---
...
Supported DEXs on Fogo: Vortex (concentrated liquidity), Fluxbeam (AMM), Fogo.fun (bonding curves).
